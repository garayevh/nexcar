    ...
    <main className="min-h-screen bg-[#0a0a0a] text-white flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-400 text-sm mt-2">Yeni hesab yaradin</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-gray-900 border border-gray-800 rounded-2xl p-8 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-sm text-gray-400">Email (isteye bagli)</label>
            <input
              type="email"
              value={form.email}
          ...
          <p className="text-center text-sm text-gray-500">
            Hesabiniz var?{' '}
            <a href="/login" className="text-[#e8ff47] hover:underline">Daxil olun</a>
          </p>
        </form>
      </div>
    </main>
